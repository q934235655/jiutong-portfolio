...
const startVideo = dialog.querySelector("[data-start-video]");
...
const assetVersion = "20260603-local-video-2";
...
const projects = {
  brand: {
    ...
    poster: "assets/images/cover-remy-xo.jpg"
  },
  doc: {
    label: "Hotel Film",
    ...
    poster: "assets/images/cover-ritz-jiuzhaigou.jpg"
  },
  audi: {
    label: "Auto Event",
    title: "广州奥迪车展发布宣传片",
    ...
    poster: "assets/images/work-commercial.png"
  },
  zuoyou: {
    label: "Brand Profile",
    ...
    poster: "assets/images/cover-zuoyou-sofa.jpg"
  },
  marriott: {
    label: "Hotel Film",
    title: "柳州三江万怡酒店宣传片",
    ...
    poster: "assets/images/cover-marriott-sanjiang.jpg"
  },
  hardrock: {
    label: "Hotel Film",
    title: "深圳硬石酒店宣传片",
    ...
    poster: "assets/images/work-music.png"
  },
  ritz: {
    label: "Hotel Film",
    title: "九寨沟丽思卡尔顿隐世酒店宣传片",
  ...
  water: {
    ...
    poster: "assets/images/cover-macau-water.jpg"
  },
  shorts: {
    ...
    poster: "assets/images/cover-personal-shorts.jpg"
  }
};
...
const loadDialogVideo = async ({ fullscreen = false } = {}) => {
  if (!pendingVideoSource) return;
  if (!dialogVideo.src) {
    dialogVideo.src = `${pendingVideoSource}?v=${assetVersion}`;
    dialogVideo.load();
  }
...
document.querySelectorAll("[data-project]").forEach((button) => {
  button.addEventListener("click", () => {
    ...
    dialogVideo.poster = project.poster ? `${project.poster}?v=${assetVersion}` : "";
    pendingVideoSource = project.video ? getVideoSource(project.video) : "";
    resetDialogVideo();
    dialog.showModal();
  });
});
...
fullPlay.addEventListener("click", async () => {
  loadDialogVideo({ fullscreen: true });
});
